                        ...
                        <div>
                            <form method="POST" action="{{ route('login.post') }}">
                                ...
                                <div class="space-y-5">
                                    ...
                                    @if (session('error'))
                                        <div
                                            class="rounded-xl border border-error-500 bg-error-50 p-4 dark:border-error-500/30 dark:bg-error-500/15 my-5">
            ...
            <div class="relative hidden lg:flex w-1/2 h-screen bg-white dark:bg-gray-900 p-10">
                <div class="flex items-center justify-center w-full h-full">
                    <img src="{{ asset('images/SDW.png') }}" alt="SD 181 Welira"
                        class="w-4/5 h-4/5 object-cover rounded-xl shadow-lg" />
                </div>
            </div>
