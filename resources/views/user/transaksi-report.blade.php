<x-dashboard-layout :title="'Laporan Transaksi'">
    ...
    <div class="space-y-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            @forelse ($months as $m)
                <div
                    class="group mb-3 p-5 border border-gray-200 rounded-2xl bg-white shadow-sm 
           ...
           dark:border-gray-800 dark:bg-white/5">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div>
                            <h2
                                class="text-lg font-semibold text-gray-800 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition">
                                {{ $m['label'] }}
                            </h2>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                Laporan transaksi bulan ini tersedia untuk diunduh.
                            </p>
                        </div>

                        <a href="{{ route('transaksi.report.download', ['bulan' => $m['ym']]) }}"
                            class="inline-flex items-center gap-2 rounded-lg border border-gray-300 
                  px-3.5 py-2 text-sm font-medium text-gray-700 transition-all
                  hover:bg-blue-50 hover:text-blue-600 hover:border-blue-300
                  dark:border-gray-700 dark:text-white 
                  dark:hover:bg-gray-800 dark:hover:border-gray-600 dark:hover:text-blue-400">
