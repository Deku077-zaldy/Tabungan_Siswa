...
<aside :class="sidebarToggle ? 'translate-x-0 lg:w-[90px]' : '-translate-x-full'"
    ...
    <div class="flex items-center justify-center pt-8 pb-7 sidebar-header">
        <a href="index.html" class="flex items-center justify-center gap-3 w-full">
            ...
            <div class="transition-all duration-300" :class="sidebarToggle ? 'flex' : 'hidden'">
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <li>
                        <a href="{{ route('dashboard.index') }}"
                            class="menu-item group flex items-center gap-3 transition-all duration-300
                            {{ Request::is('dashboard*') ? 'menu-item-active' : 'menu-item-inactive' }}"
                            :class="sidebarToggle ? 'justify-center' : 'justify-start'">

                            <svg xmlns="http://www.w3.org/2000/svg" class="shrink-0" width="24" height="24"
                            ...
                            <span class="menu-item-text transition-all duration-300"
                    ...
                    <li>
                        <a href="{{ route('profile') }}"
                            class="menu-item group flex items-center gap-3 transition-all duration-300
                            {{ Request::is('profile*') ? 'menu-item-active' : 'menu-item-inactive' }}"
                            :class="sidebarToggle ? 'justify-center' : 'justify-start'"
                            :title="sidebarToggle ? 'Profile' : ''">

                            <!-- ICON (SELALU TAMPIL) -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="shrink-0" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                                class="lucide lucide-user-round-pen-icon">
                            ...
                            <!-- TEXT (HILANG SAAT SIDEBAR DITUTUP) -->
                            <span class="menu-item-text whitespace-nowrap transition-all duration-300"
                                :class="sidebarToggle ? 'hidden' : 'inline-block'">
                                Profile
                            </span>
                        </a>
                    ...
                    <li>
                        <a href="{{ route('transaksi.history') }}"
                            class="menu-item group flex items-center gap-3 transition-all duration-300
                            {{ Request::is('transaksi-history*') ? 'menu-item-active' : 'menu-item-inactive' }}"
                            :class="sidebarToggle ? 'justify-center' : 'justify-start'"
                            :title="sidebarToggle ? 'History' : ''">
                    ...
                    <li>
                        <a href="{{ route('transaksi.report') }}"
                            class="menu-item group flex items-center gap-3 transition-all duration-300
                            {{ Request::is('transaksi-report*') ? 'menu-item-active' : 'menu-item-inactive' }}"
                            :class="sidebarToggle ? 'justify-center' : 'justify-start'"
                            :title="sidebarToggle ? 'Laporan' : ''">
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <li>
                        <a href="{{ route('profile') }}"
                            ...
                            <!-- ICON (SELALU TAMPIL) -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="shrink-0 lucide lucide-user-round-pen-icon"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                                <path d="M2 21a8 8 0 0 1 10.821-7.487" />
                    ...
                    <li>
                        <a href="{{ route('transaksi.index') }}"
                            class="menu-item group flex items-center gap-3 transition-all duration-300
                            {{ Request::is('transaksi*') ? 'menu-item-active' : 'menu-item-inactive' }}"
                            :class="sidebarToggle ? 'justify-center' : 'justify-start'"
                            :title="sidebarToggle ? 'Transaksi Tabungan' : ''">

                            <!-- ICON (SELALU TAMPIL) -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="shrink-0 lucide lucide-hand-coins-icon"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                                <path d="M11 15h2a2 2 0 1 0 0-4h-3c-.6 0-1.1.2-1.4.6L3 17" />
                    ...
                    <li>
                        <a href="{{ route('user-siswa.index') }}"
                            class="menu-item group flex items-center gap-3 transition-all duration-300
                            {{ Request::is('user-siswa*') ? 'menu-item-active' : 'menu-item-inactive' }}"
                            :class="sidebarToggle ? 'justify-center' : 'justify-start'"
                            :title="sidebarToggle ? 'Akun Siswa' : ''">

                            <!-- ICON (SELALU TAMPIL) -->
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="shrink-0 lucide lucide-user-round-plus-icon" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <li>
                        <a href="{{ route('user-wali.index') }}"
                            class="menu-item group flex items-center gap-3 transition-all duration-300
                            {{ Request::is('user-wali*') ? 'menu-item-active' : 'menu-item-inactive' }}"
                            :class="sidebarToggle ? 'justify-center' : 'justify-start'"
                            :title="sidebarToggle ? 'Akun Wali' : ''">
