<x-dashboard-layout :title="'Akun Wali'">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-1 gap-6">
        ...
        <div class="rounded-2xl border border-gray-200 p-5 lg:p-6 dark:border-gray-800 bg-white dark:bg-white/5">
            <h4 class="text-lg font-semibold text-gray-800 mb-6 dark:text-white/90">Form Tambah Siswa</h4>
            ...
            <form action="{{ route('user-siswa.store') }}" method="POST">
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="username" required placeholder="Contoh: siswa_john"
